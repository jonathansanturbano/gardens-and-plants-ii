PlantTag.destroy_all && Tag.destroy_all && Plant.destroy_all && Garden.destroy_all if Rails.env.development?
...
names = %w(Fruit\ tree Cactus Greasy\ plant Flower Ferns Conifers Varigated)
